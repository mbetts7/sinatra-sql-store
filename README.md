...
x# Products should be in many categories, and categories should have many products.  
X# The manager should be able to create and delete categories.
X# The manager should be able to see all categories
x# The manager should be able to go to a category's page and view all the products in that category.
x# The manager should be able to go to a product's page and view all the categories that product is in.
...
x-If you create the database, run `create_products_table`, then run `seed_products_table`, you'll get some seed data for the products.  Writing some data of your own for the categories might be helpful.
